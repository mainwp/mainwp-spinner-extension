...
== Installation ==
1. Please install plugin "MainWP Dashboard" and active it before install Clone Extension plugin (get the MainWP Dashboard plugin from url:https://mainwp.com/)
...
* Fixed: Issue with incorrect spintax
