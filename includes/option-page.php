        ...
        <div class="settings">
            ...
            <div class="postbox mainwp_spinner_postbox" section="3">  
                ...
                <div class="inside">
					...
					$this->create_option_field( 'sc_use_synonyms_orderly', __( 'Use synonyms Orderly' ), 'checkbox', '', array( '1' => 'Uses the thesaurus randomly to spin.','mainwp-spinner' ), '', '', '', true );
			...
			<div class="postbox mainwp_spinner_postbox" section="6">
                ...
                <div class="inside">
					...
					$this->create_option_field( 'srw_nested_spintax', __( 'Nested spintax','mainwp-spinner' ), 'select', 'false', array( 'false' => 'No', 'true' => 'Yes' ), __( 'Should Spin Rewriter also spin single words inside already spun phrases? If set to "true", the returned spun text might contain 2 levels of nested spinning syntax.', 'mainwp-spinner' ) );
					$this->create_option_field( 'srw_auto_sentences', __( 'Auto sentences','mainwp-spinner' ), 'select', 'false', array( 'false' => 'No', 'true' => 'Yes' ), __( 'Should Spin Rewriter spin complete sentences? If set to "true", some sentences will be replaced with a (shorter) spun variation.', 'mainwp-spinner' ) );
					$this->create_option_field( 'srw_auto_paragraphs', __( 'Auto paragraphs','mainwp-spinner' ), 'select', 'false', array( 'false' => 'No', 'true' => 'Yes' ), __( 'Should Spin Rewriter spin entire paragraphs? If set to "true", some paragraphs will be replaced with a (shorter) spun variation.', 'mainwp-spinner' ) );
					$this->create_option_field( 'srw_auto_new_paragraphs', __( 'Auto new paragraphs','mainwp-spinner' ), 'select', 'false', array( 'false' => 'No', 'true' => 'Yes' ), __( 'Should Spin Rewriter automatically write additional paragraphs on its own? If set to "true", the returned spun text will contain additional paragraphs.', 'mainwp-spinner' ) );
					$this->create_option_field( 'srw_auto_sentence_trees', __( 'Auto sentence trees','mainwp-spinner' ), 'select', 'false', array( 'false' => 'No', 'true' => 'Yes' ), __( 'Should Spin Rewriter automatically change the entire structure of phrases and sentences? If set to "true", Spin Rewriter will change "If he is hungry, John eats." to "John eats if he is hungry." and "John eats and drinks." to "John drinks and eats."', 'mainwp-spinner' ) );
					$this->create_option_field( 'srw_use_only_synonyms', __( 'Use only synonyms','mainwp-spinner' ), 'select', 'false', array( 'false' => 'No', 'true' => 'Yes' ), __( 'Should Spin Rewriter use only synonyms of the original words instead of the original words themselves? If set to "true", Spin Rewriter will never use any of the original words of phrases if there is a synonym available. This significantly improves the uniqueness of generated spun content.', 'mainwp-spinner' ) );
