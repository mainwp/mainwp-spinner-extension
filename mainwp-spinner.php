...
class MainWP_Spinner {
	...
	static function get_instance() {
		if ( null === self::$instance ) {
			self::$instance = new MainWP_Spinner();
		}
	...
	public function __construct() {
		...
		add_filter( 'mainwp_pre_posting_posts', array( &$this, 'pre_bulkpost_posting' ) );
	...
	public function mce_setting( $settings ) {
		...
		$valid_chil = 'p[span],span[span|p|a|b|i|u|sup|sub|img]';
...
class MainWPSpinActivator {
	...
	public function __construct() {
		...
		if ( $this->mainwpMainActivated !== false ) {
			...
			add_action( 'mainwp_activated', array( &$this, 'activate_this_extension' ) );
		}
